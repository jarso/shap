...
//    public:
//        mySet(int max_nodes) {
//            this->test = (int*)calloc(max_nodes, sizeof(int));
//            this->reset();
//        }
//        void reset() {
...
//
//            traverse(tree.children_left[root], instance, TAIL);
//            fast(tree.children_left[root], TAIL);
//            traverse(tree.children_right[root], instance, TAIL);
